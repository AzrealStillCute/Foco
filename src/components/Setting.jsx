      ...
      <div className="settingContainer">
        <div>
          <div
            ...
            className={`settingTypes ${
              activeSetting === "appearance" ? "activeSetting" : ""
            }`}
          >
            Appearance
          </div>
          <div
            ...
            className={`settingTypes ${
              activeSetting === "sound" ? "activeSetting" : ""
            }`}
          >
            Sound
          </div>
        ...
        <div className="settingRight">
          <SubSetting activeSetting={activeSetting} />
        </div>
        <div className="settingBtnContainer">
          <button className="closeBtn" onClick={() => setSettingPopup(false)}>
            Close
          </button>
          <small style={{ color: "red", fontSize: "12px" }}>
            Setting functions are not available yet.
          </small>
